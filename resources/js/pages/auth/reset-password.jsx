            ...
            <Form {...update.form()} transform={(data) => ({ ...data, token, email })} resetOnSuccess={['password', 'password_confirmation']}>
                {({ processing, errors }) => (<div className="grid gap-6">
                        ...
                        <div className="grid gap-2">
                            ...
                            <PasswordInput id="password" name="password" autoComplete="new-password" className="mt-1 block w-full" autoFocus placeholder="Password"/>
                        ...
                        <div className="grid gap-2">
                            ...
                            <PasswordInput id="password_confirmation" name="password_confirmation" autoComplete="new-password" className="mt-1 block w-full" placeholder="Confirm password"/>
