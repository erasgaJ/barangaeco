        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div className="w-full max-w-lg rounded-xl bg-white p-6 shadow-xl">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <label className="mb-1 block text-xs font-medium text-slate-600">Message <span className="text-red-500">*</span></label>
                        <textarea
                            value={form.message}
                    ...
                    <div>
                        <label className="mb-1 block text-xs font-medium text-slate-600">Schedule (optional)</label>
                        <input
                            type="datetime-local"
                ...
                <div className="mt-5 flex justify-end gap-2">
                    ...
                    >
                        {loading ? 'Publishing…' : (form.scheduled_at ? 'Schedule' : 'Publish Now')}
                    </button>
                </div>
            </div>
        </div>
                ...
                <div className="mb-6 flex items-start justify-between">
                    <div>
                        ...
                        <p className="mt-0.5 text-sm text-slate-500">
                            Publish and manage announcements for residents and collectors.
                        </p>
                    </div>
                    <button
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className={cn('rounded-full px-2 py-0.5 text-xs font-medium capitalize', AUDIENCE_STYLES[ann.target_audience])}>
                                ...
                                <p className="mt-1 text-sm text-slate-600 line-clamp-2">{ann.message}</p>
