...
## Phase 4: Delete Collector Confirmation Modal [checkpoint: 19582bc]
...
- [x] Verification: Delete a collector, confirm row is removed from the table and the user account is gone [checkpoint: 19582bc]
